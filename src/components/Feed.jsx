...
import { makeStyles, CardMedia, Card, Grid, Paper, Container } from '@material-ui/core';
...
function Feed() {
  ...
  return (
    pageLoading == true ? <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }}> <h1>loading...</h1></div> :
      <div>
        {/* header */}
          ...
          <AppBar position="static" style={{ background: "white" }}>
            <Toolbar variant="dense">
              <Grid container >
                ...
                <Grid item xs={0} sm={5} md={4} lg={6}>

                </Grid>
                <Grid item xs={6} sm={3} md={4} lg={3} className={classes.grid}>
                  <IconButton >
