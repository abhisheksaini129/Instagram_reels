    ...
    return (
            ...
            <Container>
                <Grid container className={classes.alignCenter} spacing={2}>
                    <Grid item sm={4}>
                        <Paper className={classes.crousal}>crousel</Paper>
                    </Grid>
                    <Grid item sm={5}>
                        ...
                        <CardMedia
                           ...
                           <CardContent className={classes.centerElement}>
                            ...
                            <TextField id="outlined-basic" type="email" label="Email" display="block"
                            value={email} style={{marginBottom:"0.5rem"}} onChange={(e)=>{setEmail(e.target.value)}} variant="outlined" size="small"/>   
